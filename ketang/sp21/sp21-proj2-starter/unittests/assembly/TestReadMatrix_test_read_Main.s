...
.data
msg0: .asciiz "inputs/simple0/bin/m0.bin"
m0: .word -1
m1: .word -1
m2: .word 3
...
main_test:
    ...
    # load filename inputs/simple0/bin/m0.bin into a0
    la a0 msg0
    ...
    ##################################
    # check that array pointed to by a0 == [1, 3, 5, 7, 9, 11, 13, 15, 17]
    ##################################
    # a0: exit code
    li a0, 2
    # a1: expected data
